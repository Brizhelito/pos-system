 ...
 */
export async function getCustomerSegments(startDate: Date, endDate: Date) {
  try {
    // Obtener clientes con compras
    const customers = await getCustomersWithPurchases(startDate, endDate);
    ...
    const segments = [
      ...
      { segmento: "Ocasional", cantidad: 0, porcentaje: 0, crecimiento: "0%" },
      { segmento: "Regular", cantidad: 0, porcentaje: 0, crecimiento: "0%" },
      { segmento: "Frecuente", cantidad: 0, porcentaje: 0, crecimiento: "0%" },
